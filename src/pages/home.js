    ...
    <div className='d-flex justify-content-center'>
      {
        ...
        <div className='right-side'>
          <div className='d-flex justify-content-between py-2 px-3'> <h1 onClick={about} style={{cursor: "pointer"}} >ABOUT ME</h1> <h1 onClick={projects} style={{cursor: "pointer"}}>PROJECTS</h1> </div>
